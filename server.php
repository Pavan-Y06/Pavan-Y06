...
$db = mysqli_connect('localhost', 'root', '', 'users_db'); // Don't forget to specify the database name
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
    $password = md5($password); // encrypt the password before comparing with that in the database
